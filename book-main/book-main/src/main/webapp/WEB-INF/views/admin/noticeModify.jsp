...
<body>
  <div id="register" class="inner">
    <h3 class="page">공지사항 수정</h3>
    <form enctype="multipart/form-data" method="post" action="noticeModifyOk">
      ...
      <div class="tableBg">
        <table class="table01">
          ...
          <tbody>
            ...
            <tr>
              <td><input type="text" name="title" id="title" value="${ndto.title}"></td>
            </tr>
            <tr>
              <th>내용</th>
            </tr>
            <tr>
              <td>
                <textarea name="content" id="content" >${ndto.content}</textarea>
              </td>
            </tr>
            <tr>
              <th>
              ...
              <td>
                <div id="fileList">
                  ...
                  <c:forEach var="file" items="${fileList}">
                    <p>
                      <a href="/static/temp/notice/${file}" target="_blank">${file}</a>
      ...
      <div class="btnWrap">
        <a class="btn02" href="/admin/adminNotice">취소</a>
